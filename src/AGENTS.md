...
- L'agent només pot crear o modificar fitxers `.html` i `.css`.
...
- No pot crear un `.php` encara que el contingut siga només HTML. Pot preparar
  ...
  l'alumne.
- No pot incloure PHP, JavaScript funcional, lògica de servidor, validació
  avaluable ni codi ocult dins de l'HTML o el CSS.
